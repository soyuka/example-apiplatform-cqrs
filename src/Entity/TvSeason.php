 ...
 *
 * @ORM\Entity
 * @ApiResource(iri="http://schema.org/TvSeason")
 */
class TvSeason
{
    /**
     ...
     * @var TvSeries|null
     *
     * @ORM\ManyToOne(targetEntity="App\Entity\TvSeries", inversedBy="seasons")
     * @ORM\JoinColumn(nullable=false)
     */
    private $partOfSeries;

    /**
     * @var Collection<Episode>|null
     *
     * @ORM\OneToMany(targetEntity="App\Entity\Episode", mappedBy="partOfSeason")
